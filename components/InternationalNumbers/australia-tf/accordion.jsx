...
const AustraliaTollFreeAccordionComponent = () => {

    let countryName="Australia Toll Free"
...
What is {countryName}s virtual phone number?
      ...
      <AccordionItem
        ...
        title={
          <div className="accordionItemTitle">
How does an Australia virtual phone number work?
          </div>
        }
...
export default AustraliaTollFreeAccordionComponent;
