...
const FAQAccordionComponent = () => {
    let countryName = "Germany"; // Update the country name here
  ...
  <>
    ...
    >
      <AccordionItem
        key="1" 
        aria-label="What types of Germany phone numbers are available?"
        title={
      ...
      <AccordionItem
        key="2"
        aria-label="What features come with a Germany virtual number?"
        title={
          <div className="accordionItemTitle1">
            <KeyboardArrowDownIcon />
      ...
      <AccordionItem
        key="3"
        aria-label="How fast can I set up a Germany virtual number?"
        title={
          <div className="accordionItemTitle1">
            <KeyboardArrowDownIcon />
      ...
      <AccordionItem
        key="4"
        aria-label="Can my virtual phone system grow?"
        title={
          <div className="accordionItemTitle1">
            <KeyboardArrowDownIcon />
      ...
      >
        <div className="accordionContent1">
          <p>Absolutely! Our virtual phone system is built to grow alongside your business. You can easily add more {countryName} numbers or lines as your business grows, without needing additional infrastructure.</p>
        </div>
      </AccordionItem>

      <AccordionItem
        key="5"
        aria-label="Can I use a Germany virtual number globally?"
        title={
          <div className="accordionItemTitle1">
            <KeyboardArrowDownIcon />
      ...
      >
        <div className="accordionContent1">
          <p>Yes! Our {countryName} virtual numbers can be used globally, allowing you to set up a local presence in {countryName} without needing a physical office.</p>
        </div>
      </AccordionItem>
