...
const HowToBuy = () => {
    let countryName = "Norway"; // Declare the country name
    ...
    return (
        <div className="how-to-buy-container">
            ...
            <div className="steps-container">
                ...
                <div className="step">
                    <div className="step-image">
                        <Image src={ImageForInternationalNumber3} alt="Sign Up & Complete Registration" />
                    </div>
                    <div className="step-content">
                ...
                <div className="step reverse">
                    <div className="step-image">
                        <Image src={ImageForInternationalNumber4} alt="Activate & Configure" />
                    </div>
                    <div className="step-content">
