    ...
    return (
        <>
            ...
            <p className="introText">
                Expand your business reach in {countryName} with a virtual phone number from Phonology. Create a local presence, enhance communication with your Malaysian customers, and build brand trust—all without needing a physical office. Secure your {countryName} virtual number today and unlock exciting opportunities in the vibrant Southeast Asian market!
            </p>
            <Accordion
                variant="splitted"
                hideIndicator="true"
