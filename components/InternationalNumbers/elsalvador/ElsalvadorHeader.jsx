...
import ImageForInternationalNumber from "../../../public/Assets/elsalvador.png";
import styles from "../../../styles/Internationalheader.module.css";
import USAAccordionComponent from "./accordion";

const ElsalvadorHeader = () => {
  let countryName = "El Salvador";
  let countryFlag = "https://flagsapi.com/DK/flat/64.png";
...
export default ElsalvadorHeader;
