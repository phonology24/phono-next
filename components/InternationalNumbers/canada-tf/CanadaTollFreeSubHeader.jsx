...
const CanadaTollFreeSubHeader = () => {
  let countryName = "Canada-Toll-Free";
  ...
  return (
    <div className={styles.subHeaderContainer}>
      ...
      <div className={styles.cardsContainer}>
        ...
        <Image className={styles.contactCard} src={ImageForCard} alt='cardimg'>
...
export default CanadaTollFreeSubHeader;
