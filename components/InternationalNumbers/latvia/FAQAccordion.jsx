    ...
    return (
        <>
            ...
            >
                ...
                >
                    <div className="accordionContent1">
                        <p>Your {countryName} virtual number includes features such as call forwarding, voicemail, IVR (Interactive Voice Response), call recording, and more, ensuring seamless and efficient communication with your customers.</p>
                    </div>
                </AccordionItem>
                ...
                >
                    <div className="accordionContent1">
                        <p>The setup process is quick and straightforward. Once you’ve selected your number, completed registration, and chosen your plan, your {countryName} phone number can be activated within minutes.</p>
                    </div>
                </AccordionItem>
                ...
                >
                    <div className="accordionContent1">
                        <p>Absolutely! Phonology’s virtual phone system is built to grow alongside your business. You can easily add more {countryName} numbers or lines as your business expands, without needing additional infrastructure.</p>
                    </div>
                </AccordionItem>
