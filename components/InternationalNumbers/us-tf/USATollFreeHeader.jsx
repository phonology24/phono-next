...
import ImageForInternationalNumber from "../../../public/Assets/USA.png";
import styles from "../../../styles/Internationalheader.module.css";
import USAAccordionComponent from "./accordion";

const USATollFreeHeader = () => {
  let countryName = "USA Toll Free";
  let countryFlag = "https://flagsapi.com/US/flat/64.png";
...
export default USATollFreeHeader;
