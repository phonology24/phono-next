...
const logos = [
  ...
  { id: 7, src: CiscoLogo, alt: 'Cisco Logo' },
  { id: 8, src: ElastixLogo, alt: 'Elastix Logo' },
  { id: 9, src: YeaLink, alt: 'YeaLink Logo' },
  { id: 10, src: MatrixLogo, alt: 'Matrix Logo' },
  { id: 11, src: GrandstreamLogo, alt: 'Grandstream Logo' },
  { id: 12, src: PolycomLogo, alt: 'Polycom Logo' },
];

const CampaignMarquee = () => {
  return (<>
    <h2 className='marquee-header-campaign'>Our Partners</h2>
      <Marquee gradient={false} speed={100} style={{ zIndex: -999 }} className='campaign-marquee'>
      {logos.map((logo) => (
