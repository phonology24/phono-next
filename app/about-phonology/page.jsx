...
export const metadata = {
  ...
  description:
    'Welcome to our About Us page, where innovation meets integrity in providing exceptional VoIP services for international communication. With a dedication to excellence and a commitment to customer satisfaction, we strive to redefine the standards of global connectivity.',
...
const websiteSchema = {
  ...
  '@type': 'WebSite',
  name: 'Phonology',
  url: 'https://www.phonology.io/about-phonology',
  potentialAction: {
    '@type': 'SearchAction',
    target: 'https://www.phonology.io/about-phonology{search_term_string}',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'About Phonology',
      item: 'https://www.phonology.io/about-phonology',
    },
  ],
};
